...
export function mtlCreate(mtlname) {
  if (MatLib[mtlname] === undefined) {
    console.log("errror name material");
    return mtlGetDef();
  }
  return {
    Ka: [...MatLib[mtlname][0], 1],
    Kd: [...MatLib[mtlname][1], 1],
    Ks: [...MatLib[mtlname][2], MatLib[mtlname][3]],
  };
}
